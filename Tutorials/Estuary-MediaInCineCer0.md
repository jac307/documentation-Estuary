...
+ For videos: Open the file, Right-Click on "View raw", then "Copy Link Address" / Para videos: Abre el archivo, Click derecho en "View raw", y después en "Copiar link de la dirección".  
